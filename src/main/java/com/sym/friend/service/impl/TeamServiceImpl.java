...
//          5、用户脱敏
    ...
    public boolean quitTeam(TeamQuitRequest teamQuitRequest, UserDto loginUser) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public boolean deleteTeam(long id, UserDto loginUser) {
        // 校验队伍是否存在
    ...
    @Override
    public List<TeamUserVO> getMyJoinTeam(UserDto loginUser, TeamQuery teamQuery) {
